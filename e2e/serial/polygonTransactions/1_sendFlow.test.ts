...
describe('Complete Hardhat Polygon send flow', () => {
  beforeAll(async () => {
  ...
  it('should be able to connect to hardhat Polygon', async () => {
  ...
  it('should be able to select asset to send with keyboard', async () => {
    await navigateToElementWithTestId({
      driver,
      testId: 'asset-name-0x0000000000000000000000000000000000001010_137',
    });
  ...
  it('should be able to initiate Polygon ETH transaction', async () => {
