...
export const customChainIdsToAssetNames: Record<ChainId, string> = {
  ...
  70700: 'proofofplay',
  3860316325893729: 'proofofplaytestnet',
  369: 'pulsechain',
  1380012617: 'rari',
...
export const getSimpleHashSupportedTestnetChainNames = () => {
  return [
    ...
    ChainName.godwokenTestnet,
    ChainName.lineaTestnet,
    ChainName.mantaTestnet,
    ChainName.optimismSepolia,
    ChainName.palmTestnet,
    ChainName.polygonAmoy,
    ChainName.polygonZkEvmTestnet,
    ChainName.proofOfPlayTestnet,
    ChainName.rariTestnet,
    ChainName.scrollSepolia,
    ChainName.xaiSepolia,
