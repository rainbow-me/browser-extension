...
export const NATIVE_ASSETS_PER_CHAIN: Record<ChainId, AddressOrEth> = {
  ...
  [ChainId.godwoken]: AddressZero as Address,
  [ChainId.godwokenTestnet]: AddressZero as Address,
  ...
  [ChainId.palm]: AddressZero as Address,
  [ChainId.palmTestnet]: AddressZero as Address,
  [ChainId.polygon]: MATIC_POLYGON_ADDRESS as Address,
  [ChainId.polygonAmoy]: AddressZero as Address,
  [ChainId.proofOfPlay]: AddressZero as Address,
  [ChainId.proofOfPlayTestnet]: AddressZero as Address,
  [ChainId.rari]: AddressZero as Address,
  [ChainId.rariTestnet]: AddressZero as Address,
  [ChainId.sepolia]: AddressZero as Address,
  [ChainId.xai]: AddressZero as Address,
  [ChainId.xaiSepolia]: AddressZero as Address,
  [ChainId.zkSync]: AddressZero as Address,
  [ChainId.zkSyncSepolia]: AddressZero as Address,
...
export const NATIVE_ASSETS_MAP_PER_CHAIN: Record<ChainId, AddressOrEth> = {
  ...
  [ChainId.godwoken]: ETH_ADDRESS,
  [ChainId.godwokenTestnet]: ETH_ADDRESS,
  ...
  [ChainId.palm]: ETH_ADDRESS,
  [ChainId.palmTestnet]: ETH_ADDRESS,
  [ChainId.polygon]: MATIC_MAINNET_ADDRESS,
  [ChainId.polygonAmoy]: MATIC_MAINNET_ADDRESS,
  [ChainId.proofOfPlay]: ETH_ADDRESS,
  [ChainId.proofOfPlayTestnet]: ETH_ADDRESS,
  [ChainId.rari]: ETH_ADDRESS,
  [ChainId.rariTestnet]: ETH_ADDRESS,
  [ChainId.sepolia]: ETH_ADDRESS,
  [ChainId.xai]: ETH_ADDRESS,
  [ChainId.xaiSepolia]: ETH_ADDRESS,
  [ChainId.zkSync]: ETH_ADDRESS,
  [ChainId.zkSyncSepolia]: ETH_ADDRESS,
