...
export interface Pagination {
  /**
   * If there are new pages, this value will be a non empty base64'd string
   * It should be passed along the next request to fetch the next page
   *
   * examples: "MTc1NTAxMTY4Ny04NDUzLTEyMw=="
   */
  cursor: string;
}
