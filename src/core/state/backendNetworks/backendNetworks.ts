...
import { backendNetworksQueryKey, BackendNetworksResponse } from '~/core/resources/backendNetworks/backendNetworks';
...
export const backendNetworksStore = createStore<BackendNetworksState>((set, get) => ({
...
export const useBackendNetworksStore = create(backendNetworksStore);
