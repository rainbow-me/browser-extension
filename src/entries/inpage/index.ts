...
declare global {
  interface Window {
    ...
    walletRouter: {
      ...
      providers: (RainbowProvider | Ethereum)[];
      setProviders: (rainbowAsDefault: boolean) => void;
    };
  }
}
