...
// import {
//   sparkleAnimationStyle,
//   sparkleAnimationYStyle,
// } from '../../components/Spinner/SparkleAnimation.css';
    ...
    >
      <Box paddingBottom="14px">
        <Stack alignHorizontal="center" space="16px">
          <Box
          // className={sparkleAnimationStyle}
          >
            <Box
              animate={{
              ...
              as={motion.div}
              // className={sparkleAnimationYStyle}
