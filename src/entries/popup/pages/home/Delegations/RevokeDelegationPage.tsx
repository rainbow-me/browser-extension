...
export const RevokeDelegationPage = () => {
  ...
  const handleRevoke = useCallback(async () => {
    ...
    try {
      ...
      if (result.txHash) {
        ...
        if (isLastDelegation) {
          // Call onComplete callback if provided (e.g., to toggle activation off)
  ...
  const handleCancel = useCallback(() => {
    ...
    // This ensures smart wallet is disabled even if user cancels
    if (locationState?.onComplete) {
  ...
  return (
    ...
    >
      ...
      <Box paddingHorizontal="20px" paddingVertical="20px" style={{ flex: 1 }}>
        <Stack space="20px">
          {/* Security Notice */}
          <Box
            display="flex"
          ...
          >
            ...
            <Stack space="8px">
              <Text size="12pt" weight="semibold" color="label">
                {i18n.t('delegations.revoke.security_notice')}
              </Text>
              <Text size="12pt" weight="regular" color="labelSecondary">
          ...
          <ReviewDetailsRow testId="revoke-delegation-chain">
            <Inline alignHorizontal="left" space="4px" alignVertical="center">
              <Symbol
                weight="semibold"
                size={16}
                symbol="network"
          ...
          {/* Progress indicator for multiple delegations - last element before separator */}
