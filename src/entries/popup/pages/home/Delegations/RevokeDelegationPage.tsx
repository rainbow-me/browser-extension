...
import { DelegationToRevoke, RevokeReason } from '~/core/types/delegations';
import {
...
export const RevokeDelegationPage = () => {
  ...
  const rawRevokeReason = (location.state as LocationState)?.revokeReason;
    ...
    try {
      ...
      if (result.txHash) {
        const transaction: NewTransaction = {
          ...
          value: '0',
          from: revokeAddress,
          to: currentDelegation.contractAddress ?? revokeAddress,
