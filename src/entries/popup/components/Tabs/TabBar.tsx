...
import { tabBackgroundColor } from '~/design-system/styles/core.css';
  ...
  return (
    <Box
      ...
      style={{
        ...
        backgroundColor:
          currentTheme === 'dark'
            ? 'linear-gradient(180deg, rgba(36, 37, 41, 0.7) 0%, rgba(36, 37, 41, 0.9) 100%)'
        ...
        boxShadow:
          currentTheme === 'dark'
            ...
            : '0 16px 32px 0 rgba(0, 0, 0, 0.2), 0 0 1px 0 rgba(0, 0, 0, 0.08), 0 -1px 6px 0 rgba(255, 255, 255, 0.5) inset, 0 0.5px 2px 0 rgba(255, 255, 255, 0.7) inset',
        height: height,
        zIndex: 5,
      }}
